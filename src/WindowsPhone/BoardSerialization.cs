...
namespace Spider
{
	...
	{
		[XmlAttribute] public int Suits;
		[XmlAttribute] public int MoveCount;
	...
	{
		[XmlAttribute] public int CardCount;
		[XmlAttribute] public int SourceStack;
		[XmlAttribute] public int DestStack;
		[XmlAttribute] public bool RevealedCard;
	}
}