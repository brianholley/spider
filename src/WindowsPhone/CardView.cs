	...
	internal class CardView
	{
		...
		public void Render(SpriteBatch batch)
		{
			...
			if (Card.Visible)
			{
				...
				batch.Draw(CardResources.ValueTex[(int) Card.Value], numberBottomRect, null, color, 0.0f, Vector2.Zero,
				...
				batch.Draw(CardResources.SuitTex[(int) Card.Suit], suitBottomRect, null, color, 0.0f, Vector2.Zero,
					SpriteEffects.FlipHorizontally | SpriteEffects.FlipVertically, 0);
